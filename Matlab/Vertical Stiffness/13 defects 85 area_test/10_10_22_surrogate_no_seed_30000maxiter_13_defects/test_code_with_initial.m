...
load('initial_inputs.mat')
%% inequality field needs to be created as well
ineq = zeros(12409,2);
for i = 1:12409
    ineq(i,:) = constr(x(i,:));
end
...
options.InitialPoints.X = x;
options.InitialPoints.Fval = y;
options.InitialPoints.Ineq = ineq;
disp('finished setting up initial points')
