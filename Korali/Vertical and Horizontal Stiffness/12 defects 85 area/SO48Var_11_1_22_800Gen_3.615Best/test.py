...
for i in range(num_defects * 4): # first location, second l1, third l2, fourth l3
  ...
  if i in list(range(num_defects)): # first 25 bound
    ...
    e["Variables"][i]["Upper Bound"] = math.pi/4
...
e["Solver"]["Termination Criteria"]["Max Generations"] = 800
